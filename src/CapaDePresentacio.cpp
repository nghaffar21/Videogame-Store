...
void CapaDePresentacio::consultaVideojoc() {
    ...
    try { 
        ...
        cout << "Informacio videojoc...\n";
        cout << "Nom videojoc: " + infoVjoc[0] << endl;
        cout << "Descripcio: " + infoVjoc[5] << endl;
        cout << "Qualificacio Edat: " + infoVjoc[1] << endl;
        cout << "Genere: " + infoVjoc[2] << endl;
        cout << "Data llancament: " + infoVjoc[3] << endl;
        if(infoVjoc[4] != "0")
            cout << "Minuts Estimats: " + infoVjoc[4] << endl;

        cout << "Preu: " + infoVjoc[6] << endl;

        cout << "Paquets on esta inclos: ";

        if (infoVjoc.size() == 7) cout << "Aquest videojoc no esta inclos en cap paquet";

        for (int i = 7; i < infoVjoc.size(); i++) {
...
void CapaDePresentacio::consultaVideojocs() {
    ...
    for (int i = 0; i < infoVjoc.size(); i++) {
        ...
        if (infoVjoc[i][5] != "0")
            cout << "Minuts Estimats: " + infoVjoc[i][5] << endl;
        cout << "Preu: " + infoVjoc[i][6] << endl;
        cout << "Paquets on esta inclos: ";

        if (infoVjoc[i].size() == 7) cout << "Aquest videojoc no esta inclos en cap paquet";

        for (int j = 7; j < infoVjoc[i].size(); j++) {
            cout << infoVjoc[i][j] << ", ";
        }
        cout << endl << endl;
    }
...
void CapaDePresentacio::consultaNovetatsVideojocs() {
    ...
    for (int i = 0; i < infoVjoc.size(); i++) {
        ...
        cout << infoVjoc[i][5] << "; ";
        if (infoVjoc[i][6] != "0")
            cout << "Minuts Estimats: " + infoVjoc[i][6] << endl;

        if (infoVjoc[i].size() != 7) {
            cout << "Paquets: ";
            for (int j = 7; j < infoVjoc[i].size(); j++) {
                cout << infoVjoc[i][j] << ", ";
            }
